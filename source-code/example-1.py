...
def main():
    ...
    DIRECTORY = "/Users/enoks/Programming/VROOM/training-set/static-camera/16mm/1/frames/" #+ CUTS["1"]
    ...
    frame_0 = images[index][1][750:1401, :]
    frame_1 = images[index + 1][1][750:1401, :]
    ...
    cv.imwrite("/Users/enoks/Downloads/example-1_frame-0.jpg", frame_0)
    cv.imwrite("/Users/enoks/Downloads/example-1_frame-1.jpg", frame_1)
    cv.imwrite("/Users/enoks/Downloads/example-1_result-0.jpg", result_0)
